...
Any model created in Mobius2 can be run from the graphical user interface [MobiView2](mobiviewdocs/mobiview.html) and in the [mobipy](mobipydocs/mobipy.html) python package, without the model creator having to write any binding code between the model and the user interfaces.

![MobiView2](img/mobiview_front.png)

## The Mobius2 language

The Mobius2 language can be used to model any system ordinary differential equations or discrete step equations, but has special support for mass balance of transported substances, with automatic transport of dissolved substances.
