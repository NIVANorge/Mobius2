...
Where $$v$$ is the cross-sectional average velocity, $$R_h$$ the hydraulic radius, $$S$$ the channel slope an $$n$$ the roughness coefficient (c_mann below). Now $$Q = v*A$$, where $$Q$$ is the discharge and $$A$$ the cross-sectional area. Now, $$A = V/l$$ where $$V$$ is the volume and $$l$$ the length.
...
Putting this together and rearranging we can get

$$
\frac{2}{2.71}Q^{0.943} + \frac{1}{1.16}Q^{1.16} = \left(\frac{V\sqrt{S}}{ln}\right)^{\frac{3}{2}}
$$
