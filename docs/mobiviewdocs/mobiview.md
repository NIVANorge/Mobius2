...
13. ![Statistics settings](../img/toolbar/StatSettings.png) **Statistics settings**. Here you can turn on and off what [statistics](statistics.html) you want displayed in the time series info box, in addition to a few other settings.
