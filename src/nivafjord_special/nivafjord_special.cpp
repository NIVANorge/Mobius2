...
extern "C" DLLEXPORT void
nivafjord_place_river_flux(Special_Indexed_Value *target_out, Special_Indexed_Value *density_source, Special_Indexed_Value *densities_target) {
	double dens0 = density_source->at(0);
	int closest = 0;
